...
const DEVICE_ICONS = [
  ...
  { label: 'Tablet', icon: '平板' },
  { label: 'Laptop', icon: '💻' },
  { label: 'Gaming', icon: '🎮' }
];

const DevicesView: React.FC<DevicesViewProps> = ({ childList = [], onToggleAppBlock, onUpdateDevice, lang }) => {
    ...
    <div className="space-y-10 pb-40 animate-in fade-in duration-700" dir={lang === 'ar' ? 'rtl' : 'ltr'}>
      ...
      <div className="bg-white/80 backdrop-blur-xl p-10 rounded-[4rem] border border-white shadow-2xl">
         <div className="flex justify-between items-center mb-10 px-4">
            ...
            <span className="text-[10px] font-black text-slate-400 bg-slate-100 px-4 py-1 rounded-full uppercase">إجمالي {child.appUsage?.length || 0} تطبيق مرصود</span>
         </div>
