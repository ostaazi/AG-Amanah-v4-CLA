...
export const analyzeLocationSafety = async (lat, lng) => {
...
export const analyzeContent = async (text, childName, platform, imageUri) => {
    ...
    try {
        ...
        if (response && response.text) {
            ...
            return {
                category: result.category || Category.SAFE,
                severity: result.severity || AlertSeverity.LOW,
