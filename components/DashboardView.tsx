...
const DashboardView: React.FC<DashboardViewProps> = ({ children, alerts, onTriggerDemo, lang, parentId, isLoading = false }) => {
        ...
        <div className="lg:col-span-8 space-y-10">
          ...
          {isLoading ? (
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[1, 2, 3, 4].map(i => <Skeleton key={i} className="h-24 w-full rounded-[2.5rem]" />)}
            </div>
          ) : (
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
