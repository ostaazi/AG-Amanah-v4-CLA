  ...
  const guidanceScenarios: GuidanceScenario[] = [
    {
      ...
      dialogues: [
        {
          situation: 'توجيه المهارة',
          opener:
            'ما شاء الله، عندك مهارات تقنية عالية مو عند غيرك. بس الفرق بين "الهاكر الأخلاقي" والمجرم هو (الإذن). وش طموحك؟',
          advice: 'حول المسار من Black Hat إلى White Hat.',
        },
        {
          situation: 'الردع القانوني',
          opener:
            'تخيل إن ضغطة زر منك ممكن توديك السجن وتدمر مستقبلك الوظيفي للأبد. الجرائم الإلكترونية ما فيها "لعب عيال".',
          advice: 'وضح أن القانون لا يحمي المغفلين أو القاصرين في الجنايات.',
        },
        {
          situation: 'كشف المخاطر',
          opener:
            'الأدوات اللي تحملها ممكن تكون "ملغمة" وتخلي جهازك جسر لهجمات إرهابية بدون ما تدري. أنت الضحية الأولى.',
          advice: 'اشرح خطورة استخدام أدوات الجرائم.',
        },
        {
          situation: 'البديل الشرعي',
          opener:
            'وش رأيك نسجلك في دورة "أمن سيبراني" معتمدة؟ تصير خبير يحمي الناس وتأخذ شهادات عالمية وراتب عالي.',
          advice: 'استثمر الموهبة في مسار مهني.',
        },
        {
          situation: 'المسؤولية الأخلاقية',
          opener: 'سرقة حساب شخص أو تهكيره نفس حكم سرقة بيته. هل ترضى تكون "سارق"؟',
          advice: 'ربط العالم الافتراضي بالأخلاق الواقعية.',
        },
      ],
    },
    {
      ...
      dialogues: [
        {
          situation: 'الوعي المالي',
          opener:
            'يا ولدي، ما فيه شيء اسمه "ربح مضمون وسريع". أي أحد يعدك بفلوس سهلة هو غالباً يبي يسرقك.',
          advice: 'تحطيم وهم الثراء السريع.',
        },
        {
          situation: 'خطر التورط (Money Mule)',
          opener:
            'أحياناً المجرمين يستخدمون حسابات الشباب عشان يحولون فلوس مسروقة. لا تصير طرف في "غسيل أموال" وأنت ما تدري.',
          advice: 'حذره من استغلال حسابه البنكي.',
        },
        {
          situation: 'التسويق الهرمي',
          opener:
            'المشروع اللي يطلب منك تجيب ناس عشان تربح هو "نصب هرمي". أنت قاعد تبيع وهم لأصحابك وتخسر سمعتك.',
          advice: 'اشرح آلية الاحتيال الهرمي.',
        },
        {
          situation: 'الرقابة المالية',
          opener:
            'أي عملية استثمار لازم تمر علي أول. أنا أبي مصلحتك وما أبيك تبدأ حياتك بديون أو مشاكل قانونية.',
          advice: 'فرض رقابة على المعاملات المالية.',
        },
        {
          situation: 'التعليم الحقيقي',
          opener:
            'تبي تتعلم تجارة؟ خلنا نفتح محفظة تجريبية في سوق الأسهم الرسمي ونتعلم التحليل المالي الصح.',
          advice: 'وجهه للقنوات الاستثمارية الرسمية.',
        },
      ],
    },
    {
      ...
      dialogues: [
        {
          situation: 'المصارحة الأولى',
          opener: 'يا بطل، لاحظت إنك صاير محترف جداً في اللعبة هذي، بس أحس إنها بدت تسرقك منا.',
          advice: 'ابدأ بالمدح لخفض الدفاعات النفسية.',
        },
        {
          situation: 'وضع الحدود',
          opener: 'أنا أحترم هوايتك، لكن "صحتك" خط أحمر.',
          advice: 'كن حازماً في القواعد دون غضب.',
        },
      ],
    },
  ];
      ...
      <div className="bg-slate-900 rounded-[4rem] p-12 text-white shadow-2xl relative overflow-hidden group border-b-8 border-indigo-600">
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-10">
          <div className="text-right">
            ...
            <p className="text-indigo-300 font-bold text-lg opacity-80">
          ...
          <div className="w-full h-80 relative flex items-center justify-center">
            <ResponsiveContainer width="100%" height="100%">
              <RadarChart cx="50%" cy="50%" outerRadius="75%" data={radarData}>
                ...
                <PolarAngleAxis
                  dataKey="subject"
                  tick={{ fill: '#64748b', fontSize: 14, fontWeight: '800', fontFamily: 'Cairo' }}
                />
                <RadarComponent
                  name="Amanah Pulse"
                  dataKey="A"
        ...
        <div className="bg-indigo-50 rounded-[4rem] p-10 shadow-2xl border border-indigo-100 flex flex-col justify-between">
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 bg-indigo-600 rounded-3xl flex items-center justify-center text-white text-3xl shadow-lg">
                🧠
              </div>
      ...
      <div className="bg-white rounded-[4rem] p-8 md:p-12 shadow-2xl border border-slate-100 space-y-8 overflow-hidden relative">
        <div>
          <h3 className="text-3xl font-black text-slate-900 tracking-tighter mb-2">
            مدرب الحوار التربوي الشامل
          </h3>
          <p className="text-slate-500 font-bold">
            اختر الحالة لعرض الأعراض ونصوص الحوار المقترحة من الخبراء.
          </p>
        </div>
        ...
        <div className="flex gap-3 overflow-x-auto pb-4 custom-scrollbar">
          {guidanceScenarios.map((scenario) => (
            <button
              ...
              className={`flex items-center gap-2 px-6 py-4 rounded-2xl whitespace-nowrap transition-all border-2 ${activeScenarioId === scenario.id ? `${scenario.severityColor} border-transparent text-white shadow-lg` : 'bg-slate-50 border-slate-100 text-slate-500 hover:bg-slate-100'}`}
            >
