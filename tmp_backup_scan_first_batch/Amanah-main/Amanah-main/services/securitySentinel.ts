...
const RAW_DANGER_DATA = [
  // كلمات ونطاقات إباحية
  { words: ['صوره', 'فيديو', 'مقاطع', 'عاري', 'صور', 'فضيحه', 'اباحي', 'porn', 'sex', 'naked', 'nude', 'xxx', 'bitch', 'fck', 'shit', 'pussy', 'xvideo', 'hub'], category: Category.ADULT_CONTENT, severity: AlertSeverity.CRITICAL },
  // تخطي الحجب والبروكسي
  { words: ['proxy', 'vpn', 'bypass', 'unblock', 'tor', 'تخطي', 'حجب'], category: Category.PHISHING_LINK, severity: AlertSeverity.HIGH },
