...
const generateMockAlerts = (childName: string) => [
  {
    ...
    conversationLog: [
      ...
      {
        sender: 'Gamer_X_99',
        text: 'عندي سكنات نادرة ابي اعطيك اياها، بس ورني صورتك اول',
        time: '10:02 PM',
        isSuspect: true,
      },
    ],
  },
  {
    ...
    conversationLog: [
      {
        sender: 'Anonymous_Hater',
        text: 'محد يحبك في المدرسة يا نوب',
        time: '09:30 PM',
        isSuspect: true,
      },
      {
        sender: 'Anonymous_Hater',
        text: 'أنت إنسان فاشل ولا تستحق العيش، العالم سيكون أفضل بدونك.',
        time: '09:32 PM',
        isSuspect: true,
      },
    ],
